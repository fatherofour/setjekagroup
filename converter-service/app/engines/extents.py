...
# Ported from OpenConstructionERP's ddc_dwg_parser.infer_units_from_extents
# (a single-function slice of an otherwise DDC-XML-specific, unrelated
# parser) - kept here since it operates on the same extents shape this
